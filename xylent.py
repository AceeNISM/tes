...
\033[35m                                 ║║ ║╠╩╗\033[32m║╣ ╠╦╝
\033[35m                                ╚╝╚═╝╩ ╩\033[32m╚═╝╩╚═
\033[35m                            🤡 We are al\033[32ml King 🤡
...
attacksent = """
\n\n\t\t[ # ]=====\033[1;32;40m Code By JetZ\033[1;31;40m =====[ # ]
\t\t[ # ] \033[1;33;40mCreated At 02 June 2023 \033[1;31;40m[ # ]
\t\t[ # ]========================[ # ]\n\n
\t\t[ $ ]\033[1;32;40m METHOD      : {}\033[1;31;40m
\t\t[ $ ]\033[1;32;40m IP          : {}\033[1;31;40m
\t\t[ $ ]\033[1;32;40m TIMES       : {}\033[1;31;40m
\t\t[ $ ]\033[1;32;40m PORT        : {}\033[1;33,40m
\t\t[ # ]========================[ # ]\033[0m
""".format(sinput,ip,timer,port)
...
def main():
	...
	while True:
		bot = (random.randint(9300,52222))
		sys.stdout.write(f"""\x1b]2;Joker. | Devices: [{bots}] | Spoofed Servers [19] | Server Units [8] | Clients: [18]\x07""".format (bot))
